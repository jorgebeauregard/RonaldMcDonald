...
class ChildrenTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('children')->insert([
            ...
            'flast_name' => "Galvan",
            'mlast_name' => "Victoria",
            'birthday' => Carbon::parse('2000-09-23'),
            'sex' => "Femenino",
            'scholarship_id' => 6,
            'address_street' => "Chichimeca",
            'address_number' => "03",
            'neighborhood' => "Villas Chautenco",
            'locality' => "Cuautlaxingo",
            'municipality' => "Puebla",
            'zip_code' => "72730",
            'state_id' => 1, //Publa
            'phone_1' => "2945985",
         ...
         DB::table('children')->insert([
            ...
            'municipality' => "Puebla",
            'zip_code' => "72460",
            'state_id' => 1, //Guanajuato
            'phone_1' => "012221699292",
            'phone_2' => "",
            'social' => "626-546-328",
            'zone_type' => "Urbana",
            'min_wage' => "3"
         ...
         DB::table('children')->insert([
            ...
            'flast_name' => "Padilla",
            'mlast_name' => "Gil",
            'birthday' => Carbon::parse('2000-03-24'),
            'sex' => "Masculino",
            'scholarship_id' => 1,
            'address_street' => "Calle Lagunilla",
            'address_number' => "677",
            'neighborhood' => "12 de Diciembre",
            'locality' => "Irapuato",
            'municipality' => "Guanajuato",
            'zip_code' => "95515",
            'state_id' => 17, //Guanajuato
            'phone_1' => "+52(131)-1999125",
            'phone_2' => "",
            'social' => "229-45-1158",
         ...
         DB::table('children')->insert([
            'names' => "Abraham",
            'flast_name' => "Leal",
            'mlast_name' => "Garambuyo",
            'birthday' => Carbon::parse('2003-07-05'),
            'sex' => "Masculino",
            'scholarship_id' => 5,
            'address_street' => "Paseo Solidaridadn",
            'address_number' => "10494",
            'neighborhood' => "Las Delicias",
            'locality' => "Irapuato",
            'municipality' => "Guanajuato",
            'zip_code' => "10494",
            'state_id' => 17, //Guanajuato
            'phone_1' => "+52(545)-9443867",
            'phone_2' => "",
            'social' => "642-27-0000",
            'zone_type' => "Sub-Urbana",
            'min_wage' => "<1"
         ...
         DB::table('children')->insert([
            ...
            'flast_name' => "Barbero",
            'mlast_name' => "Cordero",
            'birthday' => Carbon::parse('2018-04-18'),
            'sex' => "Femenino",
            'scholarship_id' => 1,
            'address_street' => "Rio fuerte",
            'address_number' => "53",
            'neighborhood' => "Ahome",
            'locality' => "Los Mochis",
          ...
          DB::table('children')->insert([
            ...
            'flast_name' => "Ospina",
            'mlast_name' => "Sanchez",
            'birthday' => Carbon::parse('2004-06-15'),
            'sex' => "Masculino",
            'scholarship_id' => 5,
            'address_street' => "Calle 8",
            'address_number' => "336",
           ...
           DB::table('children')->insert([
            ...
            'flast_name' => "Borges",
            'mlast_name' => "Toledo",
            'birthday' => Carbon::parse('2003-1-30'),
            'sex' => "Femenino",
            'scholarship_id' => 0,
            'address_street' => "Sepia",
            'address_number' => "510",
            'neighborhood' => "Monterreal",
        ...
        DB::table('children')->insert([
            ...
            'flast_name' => "Perez",
            'mlast_name' => "Gordo",
            'birthday' => Carbon::parse('2014-08-05'),
            'sex' => "Masculino",
            'scholarship_id' => 3,
            'address_street' => "Calle 6 Ote",
            'address_number' => "605",
            'neighborhood' => "San Juan Aquiahuac",
            'locality' => "San Andrés Cholula",
            'municipality' => "Puebla",
            'zip_code' => "72810",
            'state_id' => 1, //Pue
            'phone_1' => "044 222 481 7385",
            'phone_2' => "",
            'social' => "247-80-7360",
            'zone_type' => "Urbana",
            'min_wage' => "<1"
        ...
        DB::table('children')->insert([
            ...
            'flast_name' => "Caldera",
            'mlast_name' => "Longoria",
            'birthday' => Carbon::parse('2000-03-19'),
            'sex' => "Femenino",
            'scholarship_id' => 4,
            'address_street' => "Calle Miguel Hidalgo",
            'address_number' => "7A",
            'neighborhood' => "Centro",
            'locality' => "Zapopan",
            'municipality' => "Jalisco",
        ...
        DB::table('children')->insert([
            ...
            'flast_name' => "Aleman",
            'mlast_name' => "Aragon",
            'birthday' => Carbon::parse('2000-04-07'),
            'sex' => "Masculino",
            'scholarship_id' => 6,
            'address_street' => "Reserva Territorial Atlixcáyotl",
            'address_number' => "1301",
        ...
        DB::table('children')->insert([
            ...
            'flast_name' => "Sotto",
            'mlast_name' => "Simarro",
            'birthday' => Carbon::parse('2013-01-22'),
            'sex' => "Masculino",
            'scholarship_id' => 4,
            'address_street' => "Jesus GarciaArcia",
            'address_number' => "895",
            'neighborhood' => "Artesanos",
            'locality' => "Guadalajara",
            'municipality' => "Jalisco",
            'zip_code' => "44200",
            'state_id' => 18, //Jalisco
            'phone_1' => "01 33 3825 3068",
            'phone_2' => "",
            'social' => "025-60-4819",
            'zone_type' => "Urbana",
            'min_wage' => "<1"
        ...
        DB::table('children')->insert([
            ...
            'flast_name' => "Toro",
            'mlast_name' => "Pablos",
            'birthday' => Carbon::parse('2002-01-02'),
            'sex' => "Femenino",
            'scholarship_id' => 5,
            'address_street' => "Av. De La Paz",
            'address_number' => "57",
            'neighborhood' => "Alvaro Obregon",
            'locality' => "San Ángel",
            'municipality' => "Cd. de México",
            'zip_code' => "01000",
            'state_id' => 2, //CDMX
            'phone_1' => "01 55 5550 7350",
            'phone_2' => "",
            'social' => "341-66-2108",
            'zone_type' => "Urbana",
            'min_wage' => "<1"
